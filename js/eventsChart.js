export default class EventsBarChart {
  ...
  update(data, state) {
    ...
    const chartData = [...data]
      ...
      .slice(0, 10)
      .sort((a, b) => d3.ascending(a.extremeEvents, b.extremeEvents));
    ...
    this.x
      .domain([0, d3.max(chartData, (d) => d.extremeEvents) * 1.05])
      .range([0, innerWidth])
      .nice();
